...
> **Статус:** актуально на 31.08.2026 — этап 4 завершён (Astro-проект создан); этап 5 завершён полностью: 5a (компоненты), 5b-1 (Decap CMS + коллекция news), 5b-2 (все контент-коллекции: announcements, sveden×14, teachers, documents, contacts; исправлен критический баг путей Decap — префикс site/ в config.yml), 5c (CI/деплой: GitHub Actions + Pages, сайт опубликован на https://ntiwgg.github.io/school29-site/, base '/school29-site/', хелпер paths.ts). Этап 6 в работе: 6a–6c завершены (контакты/основные сведения/руководство — 2e25dc0; педсостав 75 педагогов — a11cba9; реальные тексты 14 подразделов «Сведений» — 6601861, c6cbf62; подраздел «Документы»: markdown-тело + блок «Прикреплённые файлы», коллекция documents в коде — attachedDocs); остался 6d (перенос файлов документов с Nubex, по решению владельца).
